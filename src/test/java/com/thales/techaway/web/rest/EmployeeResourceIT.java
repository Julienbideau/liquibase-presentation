...
import com.thales.techaway.domain.Employee;
import com.thales.techaway.repository.EmployeeRepository;
...
import static com.thales.techaway.web.rest.TestUtil.createFormattingConversionService;
...
public class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = Employee.builder()
            ...
            .commissionPct(DEFAULT_COMMISSION_PCT).build();
        return employee;
    }
    /**
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee =Employee.builder()            .firstName(UPDATED_FIRST_NAME)
            .lastName(UPDATED_LAST_NAME)
            .email(UPDATED_EMAIL)
            .phoneNumber(UPDATED_PHONE_NUMBER)
            .hireDate(UPDATED_HIRE_DATE)
            .salary(UPDATED_SALARY)
            .commissionPct(UPDATED_COMMISSION_PCT).build();
        return employee;
    }
