...
import io.julien.techaway.domain.JobHistory;
import io.julien.techaway.repository.JobHistoryRepository;
import io.julien.techaway.service.JobHistoryService;
import io.julien.techaway.web.rest.errors.ExceptionTranslator;

import io.julien.techaway.domain.enumeration.Language;
...
public class JobHistoryResourceIT {
    ...
    public void createJobHistory() throws Exception {
        ...
        Assertions.assertThat(testJobHistory.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    }
    ...
    public void updateJobHistory() throws Exception {
        ...
        Assertions.assertThat(testJobHistory.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
    }
